...
<html>
  <head>
    ...
    <title>MeetDoctor | Invoice</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="invoice.php"><i class="fa fa-fax"></i> <span>OPD</span></a></li>
            <li class="treeview">
      ...
      <div class="content-wrapper">
		...
		<div class="box box-primary">
          ...
          <div class="row no-print">
            ...
            <div class="col-xs-4" style="margin-left:37px;">
              <a href="print_invoice.php" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
